...
{
    public partial class formInversa4x4 : System.Web.UI.Page
    {
        //matriz de 4x8 
        double[,] dataMatriz = new double[4, 8];
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataMatriz[0, 3] = double.Parse(TextBox4.Text.Trim());
                dataMatriz[1, 0] = double.Parse(TextBox5.Text.Trim());
                dataMatriz[1, 1] = double.Parse(TextBox6.Text.Trim());
                dataMatriz[1, 2] = double.Parse(TextBox7.Text.Trim());
                dataMatriz[1, 3] = double.Parse(TextBox8.Text.Trim());
                dataMatriz[2, 0] = double.Parse(TextBox9.Text.Trim());
                dataMatriz[2, 1] = double.Parse(TextBox10.Text.Trim());
                dataMatriz[2, 2] = double.Parse(TextBox11.Text.Trim());
                dataMatriz[2, 3] = double.Parse(TextBox12.Text.Trim());
                dataMatriz[3, 0] = double.Parse(TextBox13.Text.Trim());
                dataMatriz[3, 1] = double.Parse(TextBox14.Text.Trim());
                dataMatriz[3, 2] = double.Parse(TextBox15.Text.Trim());
                dataMatriz[3, 3] = double.Parse(TextBox16.Text.Trim());
                banderaProceso = true;
                txtResultado.Text = txtResultado.Text + "\nMatriz Aumentada:\n";
                MostrarMatriz();
