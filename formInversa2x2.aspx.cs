...
{
    public partial class formInversa2x2 : System.Web.UI.Page
    {
        //matriz de 2x4
        double[,] dataMatriz = new double[2, 4];
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataMatriz[1, 0] = double.Parse(TextBox3.Text.Trim());
                dataMatriz[1, 1] = double.Parse(TextBox4.Text.Trim());
                banderaProceso = true;
                txtResultado.Text = txtResultado.Text + "\nMatriz Aumentada:\n";
                MostrarMatriz();
